...
(async () => {
  ...
  console.log(`TOTAL: ${list.length} receipts. Downloading costco_receipts.json...`);
  if (!list.length) {
    console.error('No receipts returned. Share any GraphQL error above and we can ' +
      'adjust the query/endpoint.');
    return;
  }
